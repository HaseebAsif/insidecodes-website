            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-posts">
                ...
                <div className="single-blog-content">
                  ...
                  <h3>
                    <Link href="/blog-details">
                      <a>The Essentials of Cybersecurity Solutions</a>
                    </Link>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-posts">
                ...
                <div className="single-blog-content">
                  ...
                  <h3>
                    <Link href="/blog-details">
                      <a>Top 10 Cybersecurity Tips for Working Place</a>
                    </Link>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-posts">
                ...
                <div className="single-blog-content">
                  ...
                  <h3>
                    <Link href="/blog-details">
                      <a>Cloud Network Detection and Response</a>
                    </Link>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-posts">
                ...
                <div className="single-blog-content">
                  ...
                  <h3>
                    <Link href="/blog-details">
                      <a>Don’t Forget Cybersecurity on Your Computer</a>
                    </Link>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-posts">
                ...
                <div className="single-blog-content">
                  ...
                  <h3>
                    <Link href="/blog-details">
                      <a>Top 5 Cybersecurity Threats in 2020</a>
                    </Link>
                  </h3>
