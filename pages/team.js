          ...
          <div className="row">
            <div className="col-lg-4 col-sm-6">
              <div className="single-team">
                <img src="/images/team/team-img-1.jpg" alt="Image" />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-team">
                <img src="/images/team/team-img-2.jpg" alt="Image" />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-team">
                <img src="/images/team/team-img-3.jpg" alt="Image" />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-team">
                <img src="/images/team/team-img-4.jpg" alt="Image" />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-team">
                <img src="/images/team/team-img-5.jpg" alt="Image" />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-team">
                <img src="/images/team/team-img-6.jpg" alt="Image" />
